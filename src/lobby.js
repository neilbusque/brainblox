// The start screen. Collects the player's name and whether they want to play
// alone, create a room, or join one by code. Resolves once with the choice:
//   { mode: "solo" | "multi", name, code }
...
export function showLobby() {
  return new Promise((resolve) => {
    ...
    if (!MULTIPLAYER_AVAILABLE) {
      msg.textContent = "Playing alone is ready. Rooms need a quick grown-up setup.";
    }
